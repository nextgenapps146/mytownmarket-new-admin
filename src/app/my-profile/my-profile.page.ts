...
export class MyProfilePage {
  ...
  ionViewDidEnter() {
    ...
    this.userName = localStorage.getItem(this.uid + "fullname");
    this.userPhone = localStorage.getItem(this.uid + "phonenumber");
  ...
  updateUser(){
    ...
    this.authService.updateUser(this.uid ,this.userName).then((res) => {
    });
  }
}