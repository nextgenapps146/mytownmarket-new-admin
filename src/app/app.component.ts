...
export class AppComponent implements OnInit {
    ...
    getLocalInfo() {
        ...
        if (this.isLoggedIn === true) {
            ...
            if (this.uid) {
                this.name = localStorage.getItem(this.uid + 'fullname');
                this.phone = localStorage.getItem(this.uid + 'phonenumber');
    ...
    handleMenuClick(item) {
        if (item === 'Add your store') {
         ...
         if (item === 'add locality') {
            this.router.navigate(['./add-locality']);    
        }
    }
